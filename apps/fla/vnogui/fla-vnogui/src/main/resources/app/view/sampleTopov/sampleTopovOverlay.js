...
(function () {
    ...
    var overlay = {
        ...
        overlayId: 'fla-overlay',
        glyphId: '*star4',
        tooltip: 'VNO Topology view',
        ...
        activate: function () {
            $log.debug("VNO topology overlay ACTIVATED");
        },
        deactivate: function () {
            stds.stopDisplay();
            $log.debug("VNO topology overlay DEACTIVATED");
        },
        ...
        keyBindings: {
            ...
            V: {
                cb: function () { stds.startDisplay('vno1'); },
                tt: 'VNO 1 view',
                gid: 'crown'
            },
            F: {
                cb: function () { stds.startDisplay('vno2'); },
                tt: 'VNO 2 view',
                gid: 'crown'
            },
            G: {
