...
public class AppUiTopovOverlay extends UiTopoOverlay {
    ...
    private static final String OVERLAY_ID = "fla-overlay";

    private static final String MY_TITLE = "VNO Topology view";
    private static final String MY_VERSION = "Beta-1.0";
    private static final String MY_DEVICE_TITLE = "Physical Device";
